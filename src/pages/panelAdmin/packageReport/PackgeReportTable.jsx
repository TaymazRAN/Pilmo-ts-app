...
import { selectAllPosts, deletePost } from "./packageReportSlice";
...
import { fetchPackageReport } from "./packageReportSlice";
import react from "react";
import purifyDate from "../../../services/purifyDate";

const PackgeReportTable = () => {
			...
			renderCell: (parameters) => {
				return (
					<div className="dataGridCell">
						{purifyDate(parameters.row.createdAt)}
					</div>
				);
			},
		},
				...
				return (
					<div className="dataGridCell">
						<Button
							...
							color="info"
							onClick={(event) =>
								navigate(`/admin/reportEdit/${cellValues.id}`)
							}
						>
		...
		<div dir="tl" className="dataGrid">
			<div className="topButtonContainer">
				<Button
					...
					onClick={(event) => navigate(`/admin/reportAdd`)}
				>
...
export default PackgeReportTable;
